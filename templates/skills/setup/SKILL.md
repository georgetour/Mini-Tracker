...
|---|---|---|---|
| TC-03-01 | AC2 | Start the app on a clean checkout | Health endpoint returns 200 |
| TC-03-02 | AC3 | Run migrations against an empty database | All migrations apply without manual steps |
