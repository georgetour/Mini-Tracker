...
|---|---|---|---|
| TC-06-01 | AC1, AC4 | Request the listing for a category | Only that category's products are returned |
| TC-06-02 | AC3 | Search by a partial product name | Matching products are returned |
| TC-06-03 | AC5 | Open a category with no products | Friendly empty state is shown |
