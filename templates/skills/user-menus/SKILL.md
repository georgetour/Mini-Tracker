...
|---|---|---|---|
| TC-05-01 | AC1 | Load the site as a signed-out visitor | Only Browse, Sign in, Register are shown |
| TC-05-02 | AC2 | Load the site as a signed-in customer | Orders, Wishlist, Profile, Sign out are shown |
