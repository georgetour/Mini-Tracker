...
|---|---|---|---|
| TC-01-01 | AC1 | Open the board | Every epic and story from the file is listed |
| TC-01-02 | AC2 | Compare badges to the file | Each badge matches its story's status line |
| TC-02-01 | AC3 | Click a task checkbox | Exactly one cell changes in the file |
| TC-02-02 | AC3, AC4 | Change a story status | The status line updates and the summary is regenerated |
